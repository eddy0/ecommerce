...
export const actionUserDetails = (id) => async (dispatch, getState) => {
    try {
        dispatch({
...
export const actionUpdateUserProfile = (user) => async (dispatch, getState) => {
    try {
        dispatch({
...
export const actionUserProfileReset = () => (dispatch) => {
    dispatch({
        type: USER_UPDATE_PROFILE_RESET
    })
}
...
export const actionListUsers = () => async (dispatch, getState) => {
    try {
        dispatch({
